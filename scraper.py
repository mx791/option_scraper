...
all_symbols = [
 'AAL', 'AAPL', 'ACB', 'AMZN', 'ASHR', 'ATVI', 'BAC', 'BBBYQ', 'BITO', 'C', 'DISH', 'DM', 'EFA', 'ET', 'EWZ', 'F', 'FXI', 'GOOGL', 'HYG', 'INVZ', 'IWM', 'JNJ', 'KVUE', 'LUMN', 'META', 'MULN', 'NKLA', 'NU', 'PBR', 'PINS', 'QQQ', 'RIG', 'SNAP', 'SNDL', 'SPY', 'TLT', 'TSLA', 'VALE', 'XELA', 'XLF', '^SPX', '^VIX'
]
