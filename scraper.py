...
all_symbols = [
 'AAL', 'AAPL', 'ACB', 'ADM', 'AMZN', 'ASHR', 'ATVI', 'BAC', 'BBBYQ', 'BITO', 'C', 'DISH', 'DM', 'EBAY', 'EFA', 'ESI.PA', 'ET', 'EWZ', 'F', 'FXI', 'GM', 'GOOGL', 'HYG', 'IT', 'INVZ', 'IWM', 'JNJ', 'KVUE', 'LUMN', 'META', 'MRNA', 'MULN', 'NFLX', 'NKLA', 'NU', 'PBR', 'PINS', 'QQQ', 'RIG', 'SNAP', 'SNDL', 'SPY', 'TLT', 'TSLA', 'VALE', 'WAVE.PA', 'XELA', 'XLF', '^SPX', '^VIX'
]
